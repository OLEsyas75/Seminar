 ...
 *git log --graph* - просмотр истории в виде дерева.
 ...
 Команда *git_merge <branch>* используется для слияния одной или нескольких веток в текущую, при этом курсор HEAD должен стоять на той ветке, в которую сливают. Затем она она устанавливает указатель текущей ветки на результирующий коммит. Кроме того, команда *git_mergetool* вызывает внешнюю программу слияний, если у Вас возникли проблемы слияния.
