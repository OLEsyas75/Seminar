 ...
 *git graph* - просмотр истории в виде дерева.
 ...
 Удалить локальную ветвь можно с помощью *git_branch_-d* при извлечении в другую ветвь, если ветка не слита - *git_branch_-D*. Для удаления удаленной ветви требуется использовать *git_push_--delete*
